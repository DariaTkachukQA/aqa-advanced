...
test("Get all book list", async () => {
    const response = await axios.get('https://jsonplaceholder.typicode.com/todos', { //calling the get API
        headers: {
...
describe ('Test demoqa', () => {
    test("Add specific book to a user", async () => {
        ...
        const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyTmFtZSI6IkRhcmlhVCIsInBhc3N3b3JkIjoiRGFyaWExMjMhISIsImlhdCI6MTczMzY4MjE1Nn0.A-cLWrjrGYaqm_4J6dHq6juzZKt7-uOdDYURJ-oaIBI";
